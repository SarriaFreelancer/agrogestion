        ...
        <div className="space-y-6 w-full max-w-4xl fade-in">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={opt.id} className="flex items-center justify-between p-4 rounded-xl bg-[var(--glass-bg)] border border-[var(--glass-border)] hover:border-primary/30 transition-colors group relative overflow-hidden">
    ...
    if (activeTab === 'estructura') {
      return (
        <div className="space-y-6 w-full max-w-4xl fade-in">
          ...
          <div className="bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl p-6 mb-6">
            <label className="block text-sm font-semibold text-[var(--text-muted)] mb-2">Niveles de jerarquía</label>
            <select
              className="w-full bg-[var(--input-bg)] border border-[var(--glass-border)] rounded-lg px-4 py-2.5 text-[var(--text-contrast)] focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {Array.from({ length: configuraciones.estructuraNiveles || 4 }, (_, index) => {
              ...
              return (
                <div key={key} className="bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl p-5">
                  <label className="block text-sm font-semibold text-[var(--text-muted)] mb-2">Nombre global Nivel {levelNumber}</label>
                  <input
                    type="text"
                    className="w-full bg-[var(--input-bg)] border border-[var(--glass-border)] rounded-lg px-4 py-2 text-[var(--text-contrast)] focus:border-primary focus:ring-1 focus:ring-primary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <div className="space-y-6 w-full max-w-4xl fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={maestro.id} className="flex items-center justify-between p-4 rounded-xl bg-[var(--glass-bg)] border border-[var(--glass-border)] hover:border-primary/30 transition-colors">
    ...
    if (activeTab === 'instancia') {
      return (
        <div className="space-y-6 w-full max-w-4xl fade-in">
          ...
          <div className="bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
    ...
    if (activeTab === 'apariencia') {
      ...
      return (
        <div className="space-y-6 w-full max-w-5xl fade-in">
          ...
          <div className="bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-xl p-4 mb-6 flex items-center justify-between">
            <div>
              ...
              return (
                <button
                  ...
                  className={`relative text-left rounded-xl overflow-hidden border transition-all duration-300 group
                    ${isActive 
                      ? 'border-primary shadow-lg bg-[var(--glass-bg)]' 
