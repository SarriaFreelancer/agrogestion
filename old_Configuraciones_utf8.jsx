...
export default function Configuraciones() {
  ...
  const sections = [
    ...
    { id: 'maquinaria',
      title: 'Maquinaria',
      description: 'Reglas de equipos y validaci├│n operativa.'
    },
    { id: 'manoObra',
      title: 'Mano de Obra',
      description: 'Control de n├│mina y personal requerido.'
    },
    { id: 'monitoreo',
      title: 'Monitoreo',
      description: 'Ajustes para capturas de campo y alertas agron├│micas.'
    },
    { id: 'estructura',
      title: 'Estructura',
      description: 'Defina la cantidad de niveles de jerarqu├¡a y la descripci├│n global de cada nivel.'
    },
    { id: 'maestros',
      title: 'Maestros',
      description: 'Habilite o desactive los cat├ílogos que desea utilizar en el sistema.'
    },
    { id: 'apariencia',
      title: 'Apariencia',
  ...
  return (
    <div className="fade-in">
      <div className="header">
        ...
        <p>Personalice su entorno de trabajo y ajuste las reglas de validaci├│n t├®cnica.</p>
      </div>
            ...
            <div key={section.id} className="glass-card" style={{ marginBottom: 0 }}>
                ...
                <div className="config-section-body">
                  <div className="config-option-list" style={{ marginBottom: '1rem' }}>
                    {[{
                      ...
                      desc: 'Activa o desactiva la secci├│n operativa de insumos.'
                    }].map(rule => (
                  ...
                  <div className="config-option-list">
                    {[
                      ...
                      { id: 'registrarGpsInsumos', label: 'Registrar ubicaci├│n en insumos', desc: 'Captura coordenadas de inicio y fin para apuntes de insumos.' }
                    ].map(rule => (
                      <label key={rule.id} className="config-option-row">
                        <input
                          type="checkbox"
                ...
                <div className="config-section-body">
                  <div className="config-option-list" style={{ marginBottom: '1rem' }}>
                    {[{
                      ...
                      desc: 'Activa o desactiva la secci├│n operativa de maquinaria.'
                    }].map(rule => (
                      <label key={rule.id} className="config-option-row">
                        <input
                          type="checkbox"
                  ...
                  <div className="config-option-list">
                    {[
                      { id: 'validarMaquinaria', label: 'Obligar Maquinaria', desc: 'Requiere equipo en labores mec├ínicas.' },
                      { id: 'registrarGpsMaquinaria', label: 'Registrar ubicaci├│n en maquinaria', desc: 'Captura coordenadas de inicio y fin para apuntes de maquinaria.' }
                    ].map(rule => (
                      <label key={rule.id} className="config-option-row">
                        <input
                          type="checkbox"
                ...
                <div className="config-section-body">
                  <div className="config-option-list" style={{ marginBottom: '1rem' }}>
                    {[{
                      ...
                      desc: 'Activa o desactiva la secci├│n operativa de mano de obra.'
                    }].map(rule => (
                      <label key={rule.id} className="config-option-row">
                        <input
                          type="checkbox"
                  ...
                  <div className="config-option-list">
                    {[
                      { id: 'validarNomina', label: 'Obligar N├│mina', desc: 'Requiere registro de personal.' },
                      { id: 'registrarGpsManoObra', label: 'Registrar ubicaci├│n en mano de obra', desc: 'Captura coordenadas de inicio y fin para apuntes de mano de obra.' }
                    ].map(rule => (
                      <label key={rule.id} className="config-option-row">
                        <input
                          type="checkbox"
              ...
              {isOpen && section.id === 'monitoreo' && (
                <div className="config-section-body">
                  <div className="config-option-list">
                    {[
                      { id: 'registrarGpsMonitoreo', label: 'Registrar GPS', desc: 'Adjunta coordenadas al registro si est├ín disponibles.' },
                      ...
                      { id: 'validarVariablesRequeridasMonitoreo', label: 'Validar variables requeridas', desc: 'Impide guardar monitoreo si una variable marcada como requerida est├í vac├¡a.' }
                    ].map(rule => (
                      <label key={rule.id} className="config-option-row">
                        <input
                          type="checkbox"
              ...
              {isOpen && section.id === 'estructura' && (
                <div className="config-section-body">
                  <div className="input-group">
                    <label className="input-label">Niveles de jerarqu├¡a</label>
                    <select
                      className="input-field"
              ...
              {isOpen && section.id === 'maestros' && (
                <div className="config-section-body">
                  <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)', marginBottom: '1.5rem' }}>
                    Seleccione los maestros que desea habilitar. Los que no est├®n seleccionados aparecer├ín ocultos en el Centro de Maestros.
                  </p>
                  <div className="config-option-list">
                    {[
                      { id: 'maestro_actividad', label: 'Actividades', icon: '­ƒôï' },
                      { id: 'maestro_maq', label: 'Maquinaria', icon: '­ƒÜ£' },
                      { id: 'maestro_mao', label: 'Trabajadores', icon: '­ƒæñ' },
                      { id: 'maestro_ins', label: 'Productos', icon: '­ƒôª' },
                      { id: 'maestro_proveedores', label: 'Proveedores', icon: '­ƒÅó' },
                      { id: 'maestro_cultivos', label: 'Cultivos', icon: '­ƒî▒' },
                      { id: 'maestro_controles', label: 'Controles Agro', icon: '­ƒö¼' },
                      { id: 'maestro_tp_act', label: 'Grupos de Actividad', icon: '­ƒÅÀ´©Å' },
                      { id: 'maestro_tipos_maquinaria', label: 'Tipos de Maquinaria', icon: 'ÔÜÖ´©Å' },
                      { id: 'maestro_cuadrillas', label: 'Cuadrillas', icon: '­ƒæÑ' },
                      { id: 'maestro_unidades', label: 'Unidades de Medida', icon: '­ƒôÅ' },
                      { id: 'maestro_tipos_productos', label: 'Tipos de Productos', icon: '­ƒöû' }
                    ].map(maestro => (
